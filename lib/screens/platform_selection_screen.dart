          ...
          children: [
              ...
              return Padding(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: selectedPlatforms.contains(platform.id)
                        ? Theme.of(context).primaryColor
                        : Colors.grey[200],
                    foregroundColor: selectedPlatforms.contains(platform.id)
                        ? Colors.white
                        : Colors.black,
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: Text(widget.isInitialSetup ? 'Continuar' : 'Guardar preferencias'),
              ),
            ),
          ],
        ),
